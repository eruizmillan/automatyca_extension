...
/**
 * Class SmsEvents
 * Events available for MauticAutomatycaBundle.
 */
final class SmsEvents
{
     ...
     * @var string
     */
    const TOKEN_REPLACEMENT = 'mautic.automatyca.sms_token_replacement';

    /**
     * The mautic.sms_on_send event is thrown when a sms is sent.
     *
     * The event listener receives a
     * MauticPlugin\MauticAutomatycaBundle\Event\SmsSendEvent instance.
     *
     * @var string
     */
    const SMS_ON_SEND = 'mautic.automatyca.sms_on_send';

    /**
     * The mautic.sms_pre_save event is thrown right before a sms is persisted.
     *
     * The event listener receives a
     * MauticPlugin\MauticAutomatycaBundle\Event\SmsEvent instance.
     *
     * @var string
     */
    const SMS_PRE_SAVE = 'mautic.automatyca.sms_pre_save';
     ...
     * @var string
     */
    const SMS_POST_SAVE = 'mautic.automatyca.sms_post_save';
     ...
     * @var string
     */
    const SMS_PRE_DELETE = 'mautic.automatyca.sms_pre_delete';
     ...
     * @var string
     */
    const SMS_POST_DELETE = 'mautic.automatyca.sms_post_delete';
     ...
     * @var string
     */
    const ON_CAMPAIGN_TRIGGER_ACTION = 'mautic.automatyca.sms.on_campaign_trigger_action';
}
