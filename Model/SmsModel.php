...
namespace MauticPlugin\MauticAutomatycaBundle\Model;
...
use MauticPlugin\MauticAutomatycaBundle\Event\SmsSendEvent;
...
class SmsModel extends FormModel implements AjaxLookupModelInterface
{
     ...
     * {@inheritdoc}
     *
     * @return \MauticPlugin\AutomatycaBundle\Entity\SmsRepository
     */
    public function getRepository()
    {
        return $this->em->getRepository('MauticAutomatycaBundle:Sms');
    }

    /**
     * @return \MauticPlugin\MauticAutomatycaBundle\Entity\StatRepository
     */
    public function getStatRepository()
    {
        return $this->em->getRepository('MauticAutomatycaBundle:Stat');
    }
        ...
        if (!empty($contacts)) {
            ...
            if (count($contacts)) {
                ...
                foreach ($contacts as $lead) {
                    ...
                    $metadata = $this->smsApi->sendSms($lead, $tokenEvent->getContent());
