...
class SmsController extends FormController
{
    ...
    {
        /** @var \MauticPlugin\AutomatycaBundle\Model\SmsModel $model */
        ...
        if ($count && $count < ($start + 1)) {
            ...
            return $this->postActionRedirect([
                ...
                'contentTemplate' => 'MauticAutomatycaBundle:Sms:index',
                'passthroughVars' => [
        ...
        $integration = $this->get('mautic.helper.integration')->getIntegrationObject('Automatyca');
        ...
        return $this->delegateView([
            ...
            'contentTemplate' => 'MauticAutomatycaBundle:Sms:list.html.php',
            'passthroughVars' => [
                'activeLink'    => '#mautic_sms_index',
                'mauticContent' => 'sms',
    ...
    public function viewAction($objectId)
    {
        ...
        /** @var \MauticPlugin\AutomatycaBundle\Entity\Sms $sms */
        ...
        return $this->delegateView([
            ...
            'viewParameters' => [
                ...
                'contacts'    => $this->forward(
                    'MauticAutomatycaBundle:Sms:contacts',
                    [
                        'objectId'   => $sms->getId(),
            ...
            'contentTemplate' => 'MauticAutomatycaBundle:Sms:details.html.php',
            'passthroughVars' => [
                'activeLink'    => '#mautic_sms_index',
                'mauticContent' => 'sms',
            ],
    ...
    public function newAction($entity = null)
    {
        ...
        if (!$entity instanceof Sms) {
            /** @var \MauticPlugin\AutomatycaBundle\Entity\Sms $entity */
            ...
            if (!$cancelled = $this->isFormCancelled($form)) {
                if ($valid = $this->isFormValid($form)) {
                    ...
                    if ($form->get('buttons')->get('save')->isClicked()) {
                        ...
                        $template  = 'MauticAutomatycaBundle:Sms:view';
                    } else {
                ...
                $template       = 'MauticAutomatycaBundle:Sms:index';
        ...
        return $this->delegateView(
            [
                'viewParameters' => [
                    'form' => $this->setFormTheme($form, 'MauticAutomatycaBundle:Sms:form.html.php', 'MauticAutomatycaBundle:FormTheme\Sms'),
                    'sms'  => $entity,
                ],
                'contentTemplate' => 'MauticAutomatycaBundle:Sms:form.html.php',
                'passthroughVars' => [
                    'activeLink'    => '#mautic_sms_index',
                    'mauticContent' => 'sms',
    ...
    public function previewAction($objectId)
    {
        ...
        if ($sms !== null && $security->hasEntityAccess('sms:smses:viewown', 'sms:smses:viewother')) {
            return $this->delegateView([
                ...
                'contentTemplate' => 'MauticAutomatycaBundle:Sms:preview.html.php',
            ]);
        }
