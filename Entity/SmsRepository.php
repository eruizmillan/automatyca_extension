 ...
 * Class SmsRepository.
 */ 
namespace MauticPlugin\MauticAutomatycaBundle\Entity;
 ...
 class SmsRepository extends CommonRepository {
    ...
    public function getEntities(array $args = [])
    {
        $q = $this->_em
            ...
            ->from('MauticAutomatycaBundle:Sms', $this->getTableAlias(), $this->getTableAlias().'.id');
    ...
    public function getSentCount()
    {
        ...
        $q->select('SUM(e.sentCount) as sent_count')
            ->from('MauticAutoamtycaBundle:Sms', 'e');
